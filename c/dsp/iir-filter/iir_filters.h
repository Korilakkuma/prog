...
void IIR_LOW_SHELVING(double f, double Q, double g, double *a, double *b) {
  ...
  a[1] = ((8.0 * pow(M_PI, 2) * pow(fc, 2)) - 2.0) / numerator;
  a[2] = (1.0 - ((2.0 * M_PI * fc) / Q) + (4.0 * pow(M_PI, 2) * pow(fc, 2))) / numerator;
  b[0] = (1 + sqrt(1 + g) * ((2 * M_PI * fc) / Q) + 4.0 * pow(M_PI, 2) * pow(fc, 2)) / numerator;
  b[1] = (8.0 * pow(M_PI, 2) * pow(fc, 2) * (1 + g) - 2) / numerator;
...
void IIR_HIGH_SHELVING(double f, double Q, double g, double *a, double *b) {
  ...
  a[1] = ((8.0 * pow(M_PI, 2) * pow(fc, 2)) - 2.0) / numerator;
  a[2] = (1.0 - ((2.0 * M_PI * fc) / Q) + (4.0 * pow(M_PI, 2) * pow(fc, 2))) / numerator;
  b[0] = ((1 + g) + sqrt(1 + g) * ((2 * M_PI * fc) / Q) + 4.0 * pow(M_PI, 2) * pow(fc, 2)) / numerator;
  b[1] = (8 * pow(M_PI, 2) * pow(fc, 2) - 2 * (1 + g)) / numerator;
...
void IIR_PEAKING(double f, double Q, double g, double *a, double *b) {
  ...
  a[1] = ((8.0 * pow(M_PI, 2) * pow(fc, 2)) - 2.0) / numerator;
  a[2] = (1.0 - ((2.0 * M_PI * fc) / Q) + (4.0 * pow(M_PI, 2) * pow(fc, 2))) / numerator;
  b[0] = (1 + ((2 * M_PI * fc) / Q) * (1 + g) + 4.0 * pow(M_PI, 2) * pow(fc, 2)) / numerator;
  b[1] = (8.0 * pow(M_PI, 2) * pow(fc, 2) - 2) / numerator;
  b[2] = (1 - ((2 * M_PI * fc) / Q) * (1 + g) + 4.0 * pow(M_PI, 2) * pow(fc, 2)) / numerator;
}
